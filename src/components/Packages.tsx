...
export default function Packages() {
	...
	return (
		<section
			id="packages"
			className="py-24 bg-gradient-to-br from-black via-black to-black relative overflow-hidden"
		>
				...
				<div className="flex flex-wrap justify-center gap-8 min-w-full">
					{loading ? (
						...
						displayPackages.map((pkg, index) => (
							<div
								key={pkg.id || index}
								className={`relative rounded-2xl p-8 transition-all transform hover:scale-105 w-full md:max-w-md lg:w-[calc(33.333%-1.5rem)]
									${ pkg.popular 
